...
//    public ItemStack setNBTAttribute(ItemStack item, NBTAttribute att, double a) {
//        if (att == NBTAttribute.attackDamage && ItemUtils.isBow(item))
//            return item;
//        if (a == 0.0D && (
//                att != NBTAttribute.attackSpeed || !ItemUtils.isWeapon(item)))
//            return delNBTAttribute(item, att);
...
//            tag.set("AttributeName", (NBTBase) new NBTTagString("generic." + att.att()));
//            tag.set("Name", (NBTBase) new NBTTagString("generic." + att.att()));
