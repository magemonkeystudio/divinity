                ...
                switch (type2) {
                    ...
                    case LORE: {
                        switch (clickEvent.getClick()) {
                            ...
                            default: {
                                new LoreGUI(itemGeneratorManager, itemGenerator, type2.getPath(this.itemType), this.itemType.getTitle()+" lore", () -> new MainStatsGUI(this.itemGeneratorManager, this.itemGenerator, this.itemType).open(player1, 1)).open(player1, 1);
                                break;
                            }
                        }
                        break;
