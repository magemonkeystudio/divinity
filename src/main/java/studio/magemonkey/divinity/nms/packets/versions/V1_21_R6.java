...
public class V1_21_R6 extends V1_21_R5 {
    ...
    public V1_21_R6(@NotNull Divinity plugin) {super(plugin);}
    ...
    public void manageEquipmentChanges(@NotNull EnginePlayerPacketEvent e, @NotNull Object packet) {
        Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            Iterable<?> worlds = (Iterable<?>) Reflex.invokeMethod(
                    Reflex.getMethod(dedicatedServer.getClass(), "Q"), // Get worlds (getAllLevels)
                    dedicatedServer
            );
